...
void RenderToolsGL::unbindCurrentFramebuffer() {
    glCall(glBindFramebuffer(GL_FRAMEBUFFER, 0));
    glCall(glViewport(0, 0, systemServices.getGraphicsSystem()->displayWidth(), systemServices.getGraphicsSystem()->displayHeight()));
}
